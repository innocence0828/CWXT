var App = function() {
    ...
    return {
        ...
        alert: function(t) {
            ...
            t.container ? "append" == t.place ? $(t.container).append(o) : $(t.container).prepend(o) : $("body").hasClass("page-container-bg-solid") || $("body").hasClass("page-content-white") ? $(".page-title").after(o) : $(".page-bar").size() > 0 ? $(".page-bar").after(o) : $(".page-breadcrumb").after(o),
